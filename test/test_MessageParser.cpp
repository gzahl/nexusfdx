...
// Global instance of MessageProcessor for testing
...
void test_valid_message_incomplete()
{
    ...
    MessageState state = processor.processMessage(msg9_Rx);
...
void test_valid_message_complete()
{
    ...
    processor.processMessage(0b00000000, 1); // Header with parity=1
    processor.processMessage(0b00000001);    // Data byte 1
    processor.processMessage(0b00000010);    // Data byte 2
    MessageState state = processor.processMessage(0b00000011); // Checksum
...
void test_unknown_fdxnr()
{
    ...
    MessageState state = processor.processMessage(msg9_Rx, 1);
...
void test_bsp_400()
{
    ...
    processor.processMessage(0b00000000, 1);
    processor.processMessage(0b10010000); // Data byte 1
    processor.processMessage(0b00000001); // Data byte 2
    MessageState state = processor.processMessage(0b10010001); // Checksum
...
void test_temp_22()
{
    processor.processMessage(0b00001000, 1); // Header = 8
    processor.processMessage(0b00010000);     // Data = 16h (22°C)
    MessageState state = processor.processMessage(0b00011000); // Checksum (XOR)
...
void test_bat_126()
{
    processor.processMessage(0b00001001, 1);  // Header = 9
    processor.processMessage(0b01111110);      // Data = 7E hex (12.6V * 10)
    MessageState state = processor.processMessage(0b01110111); // Checksum (XOR)
...
void test_depth_240()
{
    processor.processMessage(0b00000111, 1);  // Header = 7 
    processor.processMessage(0b00000000);     // Data[0] = High byte
    processor.processMessage(0b11110000);     // Data[1] = F0 hex (240 decimal)
    processor.processMessage(0b00000000);     // Data[2] = Alarm byte
    MessageState state = processor.processMessage(0b11110111); // Checksum
...
void test_bsp_251()
{
    processor.processMessage(0b00000000, 1);  // Header = 0
    processor.processMessage(0b00000000);      // High byte
    processor.processMessage(0b11111011);      // Low byte = FB hex
    MessageState state = processor.processMessage(0b00000000); // Checksum
